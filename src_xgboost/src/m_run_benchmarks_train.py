...
if __name__ == "__main__":
    ...
    import numpy as np
    np.random.seed(42)
    from utils.training import split_data, DBSCAN_Clustering,xgb_model_train
    ...
    xgb_model, train_time = xgb_model_train(X_train_clustered, y_train_clustered, params,intel_flag)
    ...
    xgb_model_full, train_time = xgb_model_train(X_train, y_train, params, intel_flag)
