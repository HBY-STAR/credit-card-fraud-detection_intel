...
if __name__ == "__main__":
    ...
    import numpy as np
    np.random.seed(42)
    from utils.training import split_data, DBSCAN_Clustering, rf_model_hyper
    ...
    rf_model, train_time = rf_model_hyper(X_train_clustered, y_train_clustered, param_grid,intel_flag)
    ...
    rf_model_full, train_time = rf_model_hyper(X_train, y_train, param_grid, intel_flag)
